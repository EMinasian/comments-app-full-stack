...
const Comment = ({ title, content, updatedAt, subComments, customClasses }: CommentType & { customClasses?: string}) => {
  return (
    <div className={`flex flex-col gap-2 text-gray-700 bg-white rounded-2xl ${customClasses ? customClasses : '' }`}>
